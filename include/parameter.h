...
sbit sensorF2Button1 = P0^5;        // 线头：301      2层面板数字1按钮  X5
sbit sensorF2Button2  = P0^6;       // 线头：302      2层面板数字2按钮  X6
sbit sensorF1Button1 = P1^4;        //     1层面板数字1按钮  X16
sbit sensorF1Button2  = P1^5;       //     1层面板数字2按钮   X17
sbit sensorF2 = P4^0;             // 线头：F2      假如油泵工作，此信号处于没有输出状态 X11
sbit sensorEmergency = P0^7;      // 线头;JT        假如有高电位输入，全部输出停止工作            X7
sbit sensor402 = P1^0;   //电梯电源开关是否打开    X14
sbit SensorStop = P1^1;   //电梯是否是工作状态    X15
